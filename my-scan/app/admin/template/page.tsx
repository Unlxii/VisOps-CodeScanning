  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-800">Dockerfile Templates</h1>
          <p className="text-sm text-slate-500">Manage global default Dockerfiles for each technology stack.</p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-2">
            {SUPPORTED_STACKS.map((stack) => (
              ...
              >
                ...
                {selectedStack === stack.id && <div className="w-2 h-2 rounded-full bg-blue-500"></div>}
              </button>
            ))}
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[600px]">
              ...
              <div className="px-4 py-3 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-sm font-semibold text-slate-700 uppercase">{selectedStack}</span>
                </div>
